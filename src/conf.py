...
BLOG_AUTHOR = "Sergei Utkin"  # (translatable)
BLOG_TITLE = {"ru": "DerNitro и все что с ним связано", "en": "DerNitro and everything connected with it"} # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://su-blog.ru/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://su-blog.ru/"
BLOG_EMAIL = "utkins01@gmail.com"
BLOG_DESCRIPTION = {"ru": "Около IT'шный блог", "en": "IT Blog"}  # (translatable)
...
LUXON_DATE_FORMAT = {
    DEFAULT_LANG: {'preset': False, 'format': 'dd-MM-yyyy HH:mm'},
    "en": {'preset': False, 'format': 'yyyy-MM-dd HH:mm'},
}
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-NVSJXFCED5"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-NVSJXFCED5');
</script>
<script data-ad-client="ca-pub-6299200544853529" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>"""
